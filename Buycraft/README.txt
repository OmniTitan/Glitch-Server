...
--- WANT SOME AWESOME EXTRA FEATURES? ------------------------------------

If you would like loads more features, such as an online webstore (http://example.buycraft.net), purchase Premium membership.
You can purchase Premium membership from your Buycraft server panel, all for a reasonable price.
...
---- CHANGE LOG ------------------------------------------------------------
	...
	Version 4.6
		...
		- Updated to the latest 1.3 CraftBukkit version
		- Removed reloading of the server when typing /buycraft secret

	Version 4.5
	
		- Bug fixes
		- Added "throttleChecking" setting value, to disable the checking throttler
